...
function PollApp ({ basePath, className }: Props): React.ReactElement<Props> {
  ...
  const options: [string, string, boolean, (value: boolean) => void][] = [
    [t('No change'), t('No change from the original 2017 sale definitions; will mean a total of 10 million AXC from genesis.'), opt10m, setOpt10m],
    [t('Split of 10x'), t('Split of 10x from the original sale; will mean a total of 100 million AXC from genesis. Apparent AXC price would be 10x lower and apparent account balances 10x higher.'), opt100m, setOpt100m],
    [t('Split of 100x'), t('Split of 100x from the original sale; will mean a total of 1 billion AXC from genesis. Apparent AXC price would be 100x lower and apparent account balances 100x higher.'), opt1b, setOpt1b],
    [t('Split of 1000x'), t('Split of 1000x from the original sale; will mean a total of 10 billion AXC from genesis. Apparent AXC price would be 1000x lower and apparent account balances 1000x higher.'), opt10b, setOpt10b]
  ];
    ...
    <main className={className}>
      ...
      <div className='pollContainer'>
        ...
        <article className='keepAlive'>
          <p><Trans key='poll1'>The AXIA AXC denomination vote: Seventy-two hours after the AXC token becomes transferable, the most popular option from this poll will decide the denomination used for the AXC token.</Trans></p>
          <p><Trans key='poll2'>This is an <a href='https://en.wikipedia.org/wiki/Approval_voting' rel='noreferrer' target='_blank'>approval vote</a>. There are four options and you may select any combination of them. The most popular of the four will be selected as the final AXC denomination three days after AXC token transfers are enabled.</Trans></p>
        ...
        <div className='pollActions'>
          <ul>
            ...
            <li>{t('No discretionary lock-voting is in place; all AXC used to vote counts the same.')}</li>

...
import type { DeriveDemocracyLock, DeriveStakingAccount } from '@axia-js/api-derive/types';
import type { Ledger } from '@axia-js/hw-ledger';
...
import type { ProxyDefinition, RecoveryConfig } from '@axia-js/types/interfaces';
import type { KeyringAddress, KeyringJson$Meta } from '@axia-js/ui-keyring/types';

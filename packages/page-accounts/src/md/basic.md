...
Accounts with under 1 AXC for AXIA are considered as nonexistent for the network. If an account's
...
Axlib and AXIA use Schnorrkel/Ristretto x25519 ("sr25519") as its key derivation and signing algorithm.

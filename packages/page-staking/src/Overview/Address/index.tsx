...
import type { DeriveAccountInfo, DeriveHeartbeatAuthor } from '@axia-js/api-derive/types';
import type { Option } from '@axia-js/types';
import type { SlashingSpans, ValidatorPrefs } from '@axia-js/types/interfaces';

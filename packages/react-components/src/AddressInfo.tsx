...
import type { DeriveBalancesAccountData, DeriveBalancesAll, DeriveDemocracyLock, DeriveStakingAccount } from '@axia-js/api-derive/types';
import type { BlockNumber, LockIdentifier, ValidatorPrefsTo145, Voting } from '@axia-js/types/interfaces';
